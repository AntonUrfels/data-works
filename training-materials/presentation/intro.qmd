...
## Just another meme, almost there

![](almost-meme.jpeg){width=600}
...
## Today's goal: A clean dataset

::: r-fit-text
-   For survey data in agronomy it should normally be a plot for a specific crop and season. In many cases, our surveys only collect data of one plot for one season and thus crop per household. In that case - each household is a row.

-   Also, we want to have interpretable variable names - as much as possible. This helps in analysis later on to keep track of what we are doing.
::: 

![](tidy-1.png){width=800}
