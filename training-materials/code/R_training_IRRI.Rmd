...
```{r}
data_most <- read.csv("../data/CSISA_IND_LDS_Rice_2017_Data.csv")
#Import using GUI. 

data = read.csv("../data/Market_data.csv")
data = read.csv("../data/Market_data.csv",skip = 1)
```
...
merged_data$total_p <-
  merged_data$basalDAP * 0.46 + merged_data$basalNPK * (merged_data$P_grade /
                                                          100) +  merged_data$`1tdDAP` * 0.46 + merged_data$`2tdDAP` * 0.46 + merged_data$`3tdDAP` *
  0.46 + merged_data$`1tdNPK` * (merged_data$P_grade / 100) + merged_data$`2tdNPK` *
  (merged_data$P_grade / 100) +  merged_data$basalSSP * 0.145 + merged_data$basalTSP * 0.45 + merged_data$`1tdSSP` *
  0.145 + merged_data$`2tdSSP` * 0.145 + merged_data$`3tdSSP` * 0.145 + merged_data$`1tdTSP` *
  0.45 + merged_data$`2tdTSP` * 0.45
